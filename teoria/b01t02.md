...
para autorizar la nueva shell:
    ...
    Pega el resultado del comando anterior como última línea y guarda. Es 
    importante que **cierres PyCharm**.
...
5. Reemplaza la primera línea por el la línea que copiaste al portapapeles en
 el primer paso:
