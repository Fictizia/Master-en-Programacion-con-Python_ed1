...
2. Asegúra que tienes instalados los paquetes `setuptools` y `wheel`:
...
12. Y crea una interfaz de línea de comandos en el módulo `awesomeness/cli.py`
