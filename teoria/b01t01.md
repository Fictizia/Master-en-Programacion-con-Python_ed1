...
7. Desarrollo de software
    ...
    1. Tipado dinámico frente a tipado estático
    2. Tipado progresivo
    3. Patrones de diseño
    4. El patrón MV* de la mano de Django
    5. Profiling y optimización
    6. Logging y monitorización
    7. Arquitecturas de servidor
...
El directorio `ejercicios` contiene el código fuente de los ejercicios. No se
trata de un módulo de Python, sino de código fuente suelto en distintos 
estadíos (enunciado, tras el paso 1, ..., solucionado) que usarás durante las 
prácticas.
