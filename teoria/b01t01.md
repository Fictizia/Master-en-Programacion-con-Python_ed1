...
3. Características de Python
    ...
    7. Ecosistema Python y entornos virtuales
    8. Excepciones y gestión de errores
    9. Manejo de archivos
    10. Entrada y salida
    11. Interfaces de línea de comandos
...
5. Programación orientada a objetos
    ...
    6. Tipos abstractos y métodos mágicos
    7. Protocolos: contextos, iteradores y generadores
    8. Tipos y metaclases
