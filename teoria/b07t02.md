...
Crea ahora una nueva carpeta `matrix` y considera el siguiente ejemplo
de multiplicación de matrices (asume que las matrices son cuadradas):
...
de la función. Intenta llegar primero a un código Python más rápido, y luego
utiliza técnicas de paralelismo, compilación al vuelo o extensiones nativas
